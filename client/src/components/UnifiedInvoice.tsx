      ...
      <div className="invoice-items-section mb-4">
        ...
        <div className="invoice-totals">
          <div className="flex justify-between items-start">
            ...
            <div className="totals-en text-left flex-1">
            ...
            <div className="totals-ar text-right flex-1" dir="rtl">
              <div className="flex items-center mb-1">
                <span className="text-gray-600 font-medium text-sm">المجموع قبل الضريبة: </span>
                <span className="text-gray-600 font-semibold text-sm mr-4">{totals.totalBeforeVat.toFixed(2)}</span>
                <img src={sarIcon} alt="SAR" className="h-3 w-3 object-contain mr-1" />
              </div>
              
              <div className="flex items-center mb-1">
                <span className="text-gray-600 font-medium text-sm">الخصم: </span>
                <span className="text-gray-600 font-semibold text-sm mr-4">{totals.totalDiscount.toFixed(2)}</span>
                <img src={sarIcon} alt="SAR" className="h-3 w-3 object-contain mr-1" />
              </div>
              
              <div className="flex items-center mb-2">
                <span className="text-gray-600 font-medium text-sm">ضريبة القيمة المضافة 15%: </span>
                <span className="text-gray-600 font-semibold text-sm mr-4">{totals.totalVat.toFixed(2)}</span>
                <img src={sarIcon} alt="SAR" className="h-3 w-3 object-contain mr-1" />
              </div>
              ...
              <div className="flex items-center mb-2">
                ...
                <span className="text-gray-600 font-bold text-sm mr-4">{totals.finalTotal.toFixed(2)}</span>
                <img src={sarIcon} alt="SAR" className="h-3 w-3 object-contain mr-1" />
              </div>
              ...
              <div className="flex items-center mb-1">
                ...
                <span className="text-gray-600 font-semibold text-sm mr-4">{totalPaid.toFixed(2)}</span>
                <img src={sarIcon} alt="SAR" className="h-3 w-3 object-contain mr-1" />
              </div>
              
              <div className="flex items-center">
                <span className="text-gray-600 font-medium text-sm">الرصيد المتبقي: </span>
                <span className="text-gray-600 font-semibold text-sm mr-4">{remainingBalance.toFixed(2)}</span>
                <img src={sarIcon} alt="SAR" className="h-3 w-3 object-contain mr-1" />
              </div>
            </div>
          </div>
