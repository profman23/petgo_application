  ...
  return (
    ...
    >
      ...
      <div className="overflow-x-auto">
        ...
        <div className="w-full relative" style={{ marginBottom: '-3px', paddingBottom: 0 }}>
          <img 
        ...
        <table className="w-full border-collapse border border-gray-300" style={{ marginTop: '-3px', borderTop: 'none' }}>
          {/* VetsVan Header Row */}
          <thead>
