...
export function VetsVanAvailabilityTable({ onSelectTimeSlot, enableDirectBooking = false }: VetsVanAvailabilityTableProps) {
  ...
  return (
    ...
    >
      ...
      <div className="w-full relative" style={{ marginBottom: '-12px', paddingBottom: 0 }}>
        <img 
      ...
      <div className="overflow-x-auto">
        <table className="w-full border-collapse border border-gray-300" style={{ marginTop: '-12px', borderTop: 'none' }}>
          {/* VetsVan Header Row */}
          <thead>
