...
export function VetsVanAvailabilityTable({ onSelectTimeSlot, enableDirectBooking = false }: VetsVanAvailabilityTableProps) {
  ...
  return (
    ...
    >
      ...
      <div className="w-full relative -mt-4 -mx-10" style={{ marginBottom: '-20px', paddingBottom: 0 }}>
        <img 
      ...
      <div className="overflow-x-auto -mx-6">
        <table className="border-collapse border border-gray-300 mt-10" style={{ marginTop: '8px', borderTop: 'none', width: 'calc(100% + 48px)' }}>
          {/* VetsVan Header Row */}
          <thead>
