...
import tableHeaderImage from "@assets/new_1753284908890.png";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export function VetsVanAvailabilityTable({ onSelectTimeSlot, enableDirectBooking = false }: VetsVanAvailabilityTableProps) {
  ...
  return (
    ...
    >
      ...
      <div className="w-full relative" style={{ marginBottom: '-37px', paddingBottom: 0 }}>
        <img 
      ...
      <div className="overflow-x-auto">
        <table className="w-full border-collapse border border-gray-300" style={{ marginTop: '-37px', borderTop: 'none' }}>
          {/* VetsVan Header Row */}
          <thead>
