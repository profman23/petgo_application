...
export const translations = {
  ar: {
    ...
    selectPatientsDesc: 'اختر الحيوان الأليف أو الحيوانات التي تحتاج للخدمة البيطرية',
    noRegisteredPatients: 'لا توجد حيوانات أليفة مسجلة',
    registerPetsFirst: 'يرجى تسجيل حيواناتك الأليفة أولاً من صفحة الحساب',
    goToPatients: 'الذهاب لتسجيل الحيوانات الأليفة',
    generalCheckUp: 'فحص عام',
    grooming: 'العناية والتنظيف',
    selectServiceType: 'اختر نوع الخدمة',
    clickToVetRequest: 'اضغط هنا للطلب البيطري',
    ...
    patients: 'الأليفة',
    myPatients: 'أليفتي',
    addPatient: 'إضافة أليف',
    patientName: 'اسم الأليف',
    patientType: 'نوع الأليف',
    patientAge: 'عمر الأليف',
    patientCondition: 'حالة الأليف',
    noPatients: 'لا توجد أليفة حتى الآن',
    uploadPhoto: 'رفع صورة',
    profilePicture: 'صورة الملف الشخصي',
    patientForm: 'نموذج الأليف',
    patientPhoto: 'صورة الأليف',
    optional: 'اختياري',
    year: 'السنة',
    month: 'الشهر',
    day: 'اليوم',
    ...
    dog: 'كلب',
    bird: 'طائر',
    selectPatientType: 'اختر نوع الأليف',
    addFirstPatient: 'أضف أول أليف لك',
  ...
  en: {
    ...
    selectPatientsDesc: 'Choose the pet or pets that need veterinary service',
    noRegisteredPatients: 'No registered pets',
    registerPetsFirst: 'Please register your pets first from the Account page',
    goToPatients: 'Go to register pets',
    generalCheckUp: 'General Check Up',
    grooming: 'Grooming',
    selectServiceType: 'Select service type',
    clickToVetRequest: 'Click Here to Vet Request',
