              ...
              <div className="flex flex-col items-center">
                ...
                <div className="text-center">
                  <a 
                    ...
                    className="inline-flex items-center gap-1 px-3 py-1.5 bg-purple-100 hover:bg-purple-200 text-purple-600 hover:text-purple-700 font-medium text-sm rounded-lg border border-purple-300 hover:border-purple-400 transition-all duration-200 cursor-pointer shadow-sm hover:shadow-md"
