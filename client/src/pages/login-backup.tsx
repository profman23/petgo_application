...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-purple-100 via-blue-50 to-purple-50 flex flex-col" dir={getDirection(language)}>
      {/* Full Screen Container */}
      <div className="flex-1 flex items-center justify-center p-2 sm:p-4">
        <div className="w-full max-w-md mx-auto h-full max-h-[95vh] overflow-y-auto">
          <Card className="h-full shadow-2xl border-0 rounded-3xl overflow-hidden" style={{ boxShadow: '0 25px 50px rgba(139, 47, 139, 0.25)' }}>
            {/* Header Section - Full Width */}
            <div className="bg-gradient-to-br from-purple-600 via-purple-700 to-purple-800 px-6 py-8 sm:py-12 text-center relative">
              {/* Background Pattern */}
              ...
              <div className="relative z-10 mb-6">
                <div className="w-24 h-24 sm:w-28 sm:h-28 mx-auto bg-white/20 backdrop-blur-sm border-2 border-white/30 rounded-3xl shadow-xl flex items-center justify-center p-3 hover:scale-105 transition-all duration-300">
                  <img 
                    src={logoImage} 
                    alt="VetsVan Logo" 
              ...
              <div className="relative z-10 text-white">
                <h1 className="text-2xl sm:text-3xl font-bold mb-2" style={{ textAlign: getTextAlign(language) }}>
                  {t.login.title}
                </h1>
                <p className="text-purple-100 text-sm opacity-90" style={{ textAlign: getTextAlign(language) }}>
                  {t.login.subtitle}
                </p>
              </div>
            </div>
            ...
            {/* Form Content */}
            <CardContent className="flex-1 p-6 sm:p-8 bg-white/98 backdrop-blur-sm">
