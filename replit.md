...
- July 29, 2025. REPLACED: Custom SVG surgical icon with user-provided surgical tools image (freepik__background__96281_1753796812008.png)
...
- July 29, 2025. ADDED: "Book Now" links below each partner logo in partners dialog without functionality
...
- July 29, 2025. ENHANCED: Made gender field required in both frontend forms and backend validation (name, type, gender all mandatory)
- July 29, 2025. DATABASE UPDATED: Changed gender column from optional to NOT NULL in PostgreSQL schema for data integrity
- July 29, 2025. UI IMPROVED: Updated patient forms to show red asterisk (*) instead of "(optional)" for gender field
- July 29, 2025. FIXED: Form value binding in edit-patient-form.tsx to use 'value' instead of 'defaultValue' for proper data display
- July 29, 2025. SUCCESS: Complete gender field workflow now functional - data saves to database and displays correctly in edit forms
- July 29, 2025. CONFIRMED: User testing successful - patient gender field now works perfectly for both creation and editing operations
