...
- July 26, 2025. IMPLEMENTED: Complete PDF download functionality for invoices using Puppeteer server-side generation
- July 26, 2025. ADDED: Professional PDF templates with bilingual support (Arabic RTL/English LTR) including company branding
- July 26, 2025. CREATED: PDF generation API endpoints (/api/generate-pdf/invoice/:bookingId and /api/invoice-pdf/:bookingId)
...
- July 27, 2025. FIXED: Arabic colon positioning issue - removed colons (:) from Arabic text in all totals sections
- July 27, 2025. ENHANCED: Invoice number display system with bilingual support - added "فاتورة رقم" alongside "Invoice:" in both PDF and View dialog
- July 27, 2025. UPDATED: All Arabic totals sections now properly display text without trailing colons for natural Arabic reading flow
- July 27, 2025. CORRECTED: Text formatting in PDF generator and invoice viewer for improved Arabic typography consistency
