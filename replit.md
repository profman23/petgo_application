...
- **Core Features**:
    ...
    - **Payment Display**: Admin and Doctor screens display payment amounts from payment_transactions table WHERE status='paid'. Booking status automatically changes to "Confirmed" when payment is completed. Amount displayed as "100 SAR" format in BookingCard component.
